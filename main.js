...
class NetatmoEnergy extends utils.Adapter {
	...
	getToken(HomeId, ClientId, ClientSecretID, User, Password) {
		...
		this.log.debug(mytools.tl('Token cred:', this.systemLang) + glob.blank + HomeId + glob.blank + ClientId + glob.blank + ClientSecretID + glob.blank + User + glob.blank + Password);
		this.log.debug(mytools.tl('Token URL:', this.systemLang) + glob.blank + glob.Netatmo_TokenRequest_URL + payload);
